...
public class IBEA_main {
	...
	public static void main(String[] args) throws JMException, IOException, ClassNotFoundException {
		...
		Configuration.logger_.addHandler(new FileHandler("results/ibea/ibea.log"));
		...
		population.printVariablesToFile("results/ibea/VAR");
		
		Configuration.logger_.info("Objectives values have been writen to file FUN");
		population.printObjectivesToFile("results/ibea/FUN");
	}
}
