...
public class Multithread {
    ...
    private static synchronized void initialize() {
        ...
        System.out.println(
                "Inform the path for the file to store information, leave in blank for default (RunningInfo.txt in the work directory):");
        printConsoleToken();
                ...
                public void run() {
                    ...
                    while (true) {
                        ...
                        try {
                            ...
                            Logger.getLogger(Multithread.class
        ...
        System.out.println(
                "Console started. You can now type your commands:");
        console.start();
    }
