 ...
 */
public class OverallConstraintViolationComparatorJM5
        implements IConstraintViolationComparatorJM5 {
    ...
    public int compare(Object o1, Object o2) {
        ...
        overall1 = ((Solution) o1).getOverallConstraintViolationDegree();
        overall2 = ((Solution) o2).getOverallConstraintViolationDegree();
    ...
    public boolean needToCompare(Solution s1, Solution s2) {
        ...
        needToCompare = (s1.getOverallConstraintViolationDegree() < 0)
                || (s2.getOverallConstraintViolationDegree() < 0);
