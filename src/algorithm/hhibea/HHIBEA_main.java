...
public class HHIBEA_main {
	...
	protected static String directory = "results/hhibea/";
	
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public static void main(String[] args) throws JMException, IOException, ClassNotFoundException {
		// Logger object and file to store log messages
		Configuration.logger_.addHandler(new FileHandler(directory+"hhibea.log"));
		
		Problem problem = new MTProblem("instances/guizzo_cas.txt");
		HyperHeuristic hh = new HHIBEA(problem);
