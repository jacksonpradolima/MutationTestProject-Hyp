...
public class SPEA2_main {
    ...
    protected static String directory = "results/spea2";
    
    @SuppressWarnings({"rawtypes", "unchecked"})
    public static void main(String[] args) throws JMException, IOException, ClassNotFoundException {
        // Logger object and file to store log messages
        Configuration.logger_.addHandler(new FileHandler(String.format("%s/%s", directory, "spea2.log")));
        ...
        System.out.println("Algoritmo: " + algorithm.getClass());
